        ...
        <div className="max-h-96 overflow-y-auto px-5 pb-4">
          {budgets.length === 0 ? (
            <div className="py-6 text-center bg-gray-50 dark:bg-gray-800 rounded-lg">
              <div className="inline-flex p-3 rounded-full bg-gray-100 dark:bg-gray-700 mb-3">
            ...
            <div className="space-y-3">
              {budgets.map(budget => {
                ...
                return (
                  <div key={budget.id} className="p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="font-medium text-gray-800 dark:text-white">{budget.name}</h3>
                      <div className="flex items-center space-x-2">
                        <span className={`text-xs px-2 py-1 rounded-full ${
                          isOverBudget ? 'bg-red-100 dark:bg-red-900/20 text-red-700 dark:text-red-400' 
                        ...
                        <div className="relative">
                          ...
                          {openMenuId === budget.id && (
                            <div className="absolute right-0 mt-1 w-36 bg-white dark:bg-gray-900 rounded-md shadow-lg border border-gray-200 dark:border-gray-800 z-10">
                              <button 
                                className="w-full flex items-center px-3 py-2 text-sm text-left text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
                                onClick={() => {
                    ...
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-1.5">
                      <div 
                        className={isOverBudget ? 'bg-red-500 dark:bg-red-500 h-1.5 rounded-full' : 'bg-blue-500 dark:bg-blue-500 h-1.5 rounded-full'}
