          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input 
                type="text" 
                id="description"
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  id="amount"
                  step="0.01"
                  className="w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100"
                  placeholder="0,00"
                  value={amount}
                  required
            ...
            <div>
              ...
              <div className="relative" ref={calendarRef}>
                <button 
                  type="button"
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-1 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white dark:bg-gray-800 text-left flex justify-between items-center text-gray-900 dark:text-gray-100"
                ...
                {isCalendarOpen && (
                  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 dark:bg-black/70">
                    <div className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl p-4 w-[320px] max-w-full animate-in fade-in-50 zoom-in-95 duration-100">
                      ...
                      <div className="grid grid-cols-7 gap-1 bg-gray-50 dark:bg-gray-800 rounded-lg p-2">
            ...
            <div className="pt-4 flex justify-end">
              <button
                type="button"
                className="px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-lg mr-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                onClick={() => { setIsOpen(false); setEditingTransaction(null); }}
              >
                Cancelar
              </button>
